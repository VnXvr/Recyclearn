...
public class Seller_Security extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    Button sellerpassword, selleremail;
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_sellerhome:
                Intent intent = new Intent(Seller_Security.this, SellerDashboard.class);
                startActivity(intent);
                break;
            case R.id.nav_sellerprofile:
                Intent intent1 = new Intent(Seller_Security.this, SellerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_sellerredeem:
                Intent redeem = new Intent(Seller_Security.this, SellerRedeem.class);
                startActivity(redeem);
                break;
            case R.id.nav_sellerlocation:
                Intent intent2 = new Intent(Seller_Security.this, SellerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_sellerSecurity:
                Intent security = new Intent(Seller_Security.this, Seller_Security.class);
                startActivity(security);
                break;
            case R.id.nav_sellerinfo:
                Intent intent4 = new Intent(Seller_Security.this, SellerAboutUs.class);
                startActivity(intent4);
                break;
            case R.id.nav_sellerlogout:
                Intent intent3 = new Intent(Seller_Security.this, MainActivity.class);
    ...
    public void opensellerprofile() {
        Intent intent = new Intent(Seller_Security.this, SellerProfile.class);
        startActivity(intent);
