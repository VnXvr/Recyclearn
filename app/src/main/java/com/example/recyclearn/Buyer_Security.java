...
public class Buyer_Security extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    Button buyerpassword, buyeremail;
...
// navigation menu items declaration
        navigationView.setNavigationItemSelectedListener(Buyer_Security.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(Buyer_Security.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_buyerprofile:
                Intent intent1 = new Intent(Buyer_Security.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(Buyer_Security.this, BuyerAboutUs.class);
    ...
    public void openbuyerprofile(){
        Intent intent = new Intent(Buyer_Security.this, BuyerProfile.class);
        startActivity(intent);
    }
}