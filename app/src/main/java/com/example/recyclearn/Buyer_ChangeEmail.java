...
public class Buyer_ChangeEmail extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
            ...
            public void onClick(View v) {
                ...
                documentReference.update(hashMap).addOnSuccessListener(new OnSuccessListener() {
                    ...
                    public void onSuccess(Object o) {
                        Intent back = new Intent(Buyer_ChangeEmail.this, Buyer_Security.class);
                        startActivity(back);
...
// navigation menu items declaration
        navigationView.setNavigationItemSelectedListener(Buyer_ChangeEmail.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(Buyer_ChangeEmail.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_buyerprofile:
                Intent intent1 = new Intent(Buyer_ChangeEmail.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(Buyer_ChangeEmail.this, BuyerAboutUs.class);
    ...
    public void openbuyerprofile(){
        Intent intent = new Intent(Buyer_ChangeEmail.this, BuyerProfile.class);
        startActivity(intent);
    }
}